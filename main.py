...
# speak("was good son of a bitch prem")


def wishme():
    # speak("Welcome Back retard")
    ...
    speak("what you want me to do cuh")
...
def personal():
    speak(
        "I am kausthubh's personal AI assistent...,bluezai, .. I am developed by kausthubh and i like you bitch"
    )
...
#bluezai features
            ...
            i can shut down or restart your computer,
